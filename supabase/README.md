...
| [`migrations/20260608020234_accounts_brand_institution.sql`](migrations/20260608020234_accounts_brand_institution.sql) | **Identidade visual.** Colunas `brand` (bandeira do cartão) e `institution` (banco/fintech) em `accounts`, guardando um slug do registro de marcas do client (logos via `simple-icons` + fallback de iniciais). |
